    ...
    <motion.svg
      ...
      <g>
        <path
          ...
          transform-origin="412px 223.75px"></path>
        <path
          d="M412 263.5L412 184"
      ...
      <path
        ...
        stroke-dashoffset="0px"
        stroke-dasharray="1px 1px"
        transform-origin="436px 199px"></path>
      <path
        d="M460 96L460 64"
        stroke="#000"
        stroke-opacity="0.25"
      ...
      <path
        ...
        stroke-dashoffset="0px"
        stroke-dasharray="1px 1px"
        transform-origin="460px 211.5px"></path>
      <path
      ...
      <path
        ...
        stroke-dashoffset="0px"
        stroke-dasharray="1px 1px"></path>
      <circle cx="460" cy="64" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="460"
        cy="64"
        r="3.5"
        ...
        stroke-opacity="0.25"
        opacity="0.4"></circle>
      <circle cx="308" cy="64" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="308"
        cy="64"
        r="3.5"
        ...
        stroke-opacity="0.25"
        opacity="0.4"></circle>
      <circle cx="69" cy="173" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="69"
        cy="173"
        r="3.5"
        ...
        stroke-opacity="0.25"
        opacity="0.4"></circle>
      <circle cx="436" cy="214" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="436"
        cy="214"
        r="3.5"
        ...
        stroke-opacity="0.25"
        opacity="0.4"></circle>
      <circle cx="460" cy="240" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="460"
        cy="240"
        r="3.5"
        ...
        stroke-opacity="0.25"
        opacity="0.4"></circle>
      <circle cx="560" cy="214" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="560"
        cy="214"
        r="3.5"
        ...
        stroke-opacity="0.25"
        opacity="0.4"></circle>
      <circle cx="560" cy="197" fill="#000" r="4" opacity="0.4"></circle>
      <circle
        cx="560"
        cy="197"
        r="3.5"
      ...
      <defs>
        ...
        <motion.linearGradient
          ...
          <stop stop-color="#287ed7" stop-opacity="0"></stop>
          <stop offset="0.05" stop-color="#287ed7"></stop>
          <stop offset="1" stop-color="#287ed7" stop-opacity="0"></stop>
        </motion.linearGradient>
        <motion.linearGradient
          gradientUnits="userSpaceOnUse"
          id="blue-pulse-2"
