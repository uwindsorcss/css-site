...
const App = () => {
  ...
  if(width <= 900) return <>
    ...
    {background}
    <div className="flex justify-center items-center absolute h-screen w-screen flex-col top-0">
      <div className="flex flex-row w-5/6 h-2/3 place-items-stretch gap-4">
          <div className="m-10 px-10 rounded-lg bg-stone-100 col-span-6 h-full">
            <Table schedule={schedule} />
          </div>
